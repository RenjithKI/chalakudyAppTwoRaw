...
@Component
/*@Primary*/
public class EventProcessorDaoImpl2original implements EventProcessorDao {	
	
	private Map<String, Map<String, Long>> map = new HashMap<>(2);
	final String textFilePath;
	
	@Autowired
	public EventProcessorDaoImpl2original(@Value( "${textFile.path}" ) final String textFilePath) throws IOException{
